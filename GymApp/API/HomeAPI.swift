...
class HomeAPI {
    ...
    func getHomeInfo(for userAuthentication: Authentication,
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + responseTime) {
            ...
            let wellnessData = [
                WellnessAppData(slug: "calm", imageURI: URL(string: "https://play-lh.googleusercontent.com/S76GphUu2pZa249td2Bb4XAhLcPRrFdL1zp_5qU1ouukvRq9r0-8jJ-CruaTtdT6g84=s360-rw")!, title: "Calm", description: "Sleep, Meditation and Relaxation"),
                WellnessAppData(slug: "strava", imageURI: URL(string: "https://play-lh.googleusercontent.com/j-ZV144PlVuTVsLuBzIKyEw9CbFnmWw9ku2NJ1ef0gZJh-iiIN1nrNPmAtvgAteyDqU=s360-rw")!, title: "Strava", description: "Track activity & map routes"),
                WellnessAppData(slug: "lifesum", imageURI: URL(string: "https://play-lh.googleusercontent.com/xbF2DUtTeEB7E4wy0hArgj2QoxlufPiXei72K9t_1PdfFmM-ws-zrJAB7ODRwGU8smg=s360-rw")!, title: "Lifesum", description: "Get happier and helthier through better eating"),
                WellnessAppData(slug: "meditopia", imageURI: URL(string: "https://play-lh.googleusercontent.com/3FGXUY3twWiTEoppfutcIzgLT6LUwHgsQmYAkkUqTj6U_c4zHyy_dffYwu_0SavPvmjb=s360-rw")!, title: "Meditopia", description: "Inner peace through meditation, sleep stories and relaxing songs"),
                WellnessAppData(slug: "fabulous", imageURI: URL(string: "https://is4-ssl.mzstatic.com/image/thumb/Purple125/v4/73/bb/0c/73bb0c39-d33b-72d1-d7db-4148187c891b/AppIcon-0-0-1x_U007emarketing-0-0-0-4-0-0-sRGB-0-0-0-GLES2_U002c0-512MB-85-220-0-0.png/350x350.png")!, title: "Fabuluous", description: "Build heathier habits with your own personal coach and hapiness trainer"),
                WellnessAppData(slug: "neou", imageURI: URL(string: "https://play-lh.googleusercontent.com/gA1EnzqYkjI6vLLOm3JGbK4bcWKchJQ5eXhr8cHQ_HDGtrLyyDi7NPMka_N9l__9lzY=s360-rw")!, title: "Neou", description: "Solo & family workouts"),
                WellnessAppData(slug: "yogaia", imageURI: URL(string: "https://play-lh.googleusercontent.com/K67cfyPh1HTQf91sZV7-O6uhTZJhXeZ3EsnvvAQQ4hT0gUJQTZtZ8dx4wLffQgNpo-c=s360-rw")!, title: "Yogaia", description: "Strenghten your body and mind"),
                WellnessAppData(slug: "bt-fit", imageURI: URL(string: "https://play-lh.googleusercontent.com/dRzgjaDIvpDETOQZt0qrhY5HNd1ckQJM37S4xTsxau-KK0k1we4s-qh4zDpN47vs8tCK=s360-rw")!, title: "BTFIT", description: "Online on-demand fitness powered by Bodytech"),
                WellnessAppData(slug: "zen-app", imageURI: URL(string: "https://play-lh.googleusercontent.com/WyrPH1z2CmQhf7f9AaWM0FDLF32lFLVUz9w4aQTFaoc3KfZYNmVdSui9e9Ihvq5gYw=s360-rw")!, title: "ZenApp", description: "Meditation & Personal Development"),
                WellnessAppData(slug: "wellness-coach", imageURI: URL(string: "https://play-lh.googleusercontent.com/yBKuVfq8LV_1VcDK1jJTTKGZLuht0KRYEPRx4NDLd5bDo6RiZhvEdsoypTlfe5am2Q=s360-rw")!, title: "Wellness Coach", description: "Mind, body and sleep"),
            ]
